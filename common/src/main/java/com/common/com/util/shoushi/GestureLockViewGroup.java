package com.common.com.util.shoushi;
...
import com.common.com.util.shoushi.listener.GestureUnmatchedExceedListener;
...
public class GestureLockViewGroup extends RelativeLayout {
     ...
     */
    private int mNoFingerColor =0xFF68D2FC;
    ...
    private void initViews() {
        ...
        if (mGestureLockViews == null) {
            ...
            mGestureLockViewWidth = (int) ( mWidth * 1.0f / (8 * mCount ));
            ...
            for (int i = 0; i < mGestureLockViews.length; i++) {
                ...
                LayoutParams lockerParams = new LayoutParams(
                        mGestureLockViewWidth*4, mGestureLockViewWidth*4);
